...
$appName = company()['name'] ?? 'Bank Sampah';
$error = '';
...
@media(max-width:760px){
  ...
  .brand-mark{width:58px;height:58px;border-radius:18px;font-size:28px}
...
<div class="wrap">
  <div class="brand">
    ...
    <div class="brand-text">
      <b>Bank Sampah</b>
      <small>Pastel Sage Edition</small>
    </div>
  </div>
  <div class="card">
  ...
  <div class="footer">© <?= date('Y') ?> Bank Sampah — Dibuat dengan ♡</div>
</div>
</body>
</html>
